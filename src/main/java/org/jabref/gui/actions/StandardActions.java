...
public enum StandardActions implements Action {
    ...
    ABBREVIATE(Localization.lang("Abbreviate journal names or book titles")),
    ABBREVIATE_DEFAULT("Default", Localization.lang("Abbreviate journal names or book titles of the selected entries (DEFAULT abbreviation)"), KeyBinding.ABBREVIATE),
    ABBREVIATE_MEDLINE("Medline", Localization.lang("Abbreviate journal names or book titles of the selected entries (MEDLINE abbreviation)")),
    ABBREVIATE_SHORTEST_UNIQUE("Shortest Unique", Localization.lang("Abbreviate journal names or book titles of the selected entries (SHORTEST UNIQUE abbreviation)")),
    UNABBREVIATE(Localization.lang("Expand journal names or book titles"), Localization.lang("Expand journal names or book titles of the selected entries"), KeyBinding.UNABBREVIATE),
